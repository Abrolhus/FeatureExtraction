...
void extract_features_from_lines(Mat binaryImg, vector<cv::Vec4i> lines, vector<field_point> &result_intersections){
	vector<Vec4i> ellipse_prob_lines;
	line_most_prob_features(binaryImg, lines, ellipse_prob_lines, result_intersections);
}
